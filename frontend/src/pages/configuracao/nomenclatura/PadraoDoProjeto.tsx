/** SP-104 · Padrão de nomenclatura do projeto.
 *
 ...
 *
 *  Convive com os "Padrões avançados" da aba ao lado, que são a bancada local
 *  de quem audita e aceitam separador por bloco e tipos.
 */
...
export default function AbaPadraoDoProjeto() {
