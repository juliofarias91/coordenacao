 ...
 */
import { accPresetPatterns, matchBestPattern, validateName, findDuplicates, findContentDuplicates, exampleFor, checkFilenameHygiene } from '../src/lib/auditer/patterns.js'
